...
export type Subscription = {
  ...
  satoriCreated?: Maybe<Satori>;
  satoriFromKafka?: Maybe<Array<Maybe<Satori>>>;
};
...
export type SubscriptionResolvers<ContextType = ModuleContext, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = {
  satoriCreated?: SubscriptionResolver<Maybe<ResolversTypes['Satori']>, "satoriCreated", ParentType, ContextType>;
  satoriFromKafka?: SubscriptionResolver<Maybe<Array<Maybe<ResolversTypes['Satori']>>>, "satoriFromKafka", ParentType, ContextType>;
};
...
export function CreatePositionInputSchema(): z.ZodObject<Properties<CreatePositionInput>> {
  return z.object<Properties<CreatePositionInput>>({
    candidateId: definedNonNullAnySchema,
    description: z.string().nullish(),
    name: z.string(),
    requirements: z.array(definedNonNullAnySchema.nullable()).nullish(),
    status: PositionStatusSchema
  })
}

export function CreatePositionInterviewInputSchema(): z.ZodObject<Properties<CreatePositionInterviewInput>> {
  return z.object<Properties<CreatePositionInterviewInput>>({
    candidateId: definedNonNullAnySchema,
    description: z.string().nullish(),
    name: z.string(),
    positionId: definedNonNullAnySchema,
    scoreId: definedNonNullAnySchema,
    status: InterviewStatusSchema,
    type: InterviewTypeSchema
  })
}

export function CreateSatoriInputSchema(): z.ZodObject<Properties<CreateSatoriInput>> {
  return z.object<Properties<CreateSatoriInput>>({
    defaultScoreTemplate: SatoriScoreTemplateSchema,
    description: z.string().nullish(),
    name: z.string(),
    type: SatoriTypeSchema
  })
}

export function CreateSatoriMapInputSchema(): z.ZodObject<Properties<CreateSatoriMapInput>> {
  return z.object<Properties<CreateSatoriMapInput>>({
    description: z.string().nullish(),
    items: z.array(definedNonNullAnySchema.nullable()).nullish(),
    name: z.string()
  })
}
...
export const InterviewStatusSchema = z.enum(['Active', 'Closed', 'Complete', 'Draft']);

export const InterviewTypeSchema = z.enum(['External', 'Internal']);

export const PositionStatusSchema = z.enum(['Active', 'Closed', 'Complete', 'Draft']);

export const SatoriScoreTemplateSchema = z.enum(['FiveStars', 'Percents', 'TenStars', 'YesNo']);

export const SatoriTypeSchema = z.enum(['Hard', 'Other', 'Soft']);

export function ScoreSatoriInputSchema(): z.ZodObject<Properties<ScoreSatoriInput>> {
  return z.object<Properties<ScoreSatoriInput>>({
    notes: z.string().nullish(),
    satoriId: definedNonNullAnySchema,
    template: SatoriScoreTemplateSchema,
    value: z.number()
  })
}

export function UpdatePositionInputSchema(): z.ZodObject<Properties<UpdatePositionInput>> {
  return z.object<Properties<UpdatePositionInput>>({
    candidateId: definedNonNullAnySchema.nullish(),
    description: z.string().nullish(),
    id: definedNonNullAnySchema,
    name: z.string(),
    requirements: z.array(definedNonNullAnySchema.nullable()).nullish(),
    status: PositionStatusSchema.nullish()
  })
}

export function UpdatePositionInterviewInputSchema(): z.ZodObject<Properties<UpdatePositionInterviewInput>> {
  return z.object<Properties<UpdatePositionInterviewInput>>({
    candidateId: definedNonNullAnySchema.nullish(),
    description: z.string().nullish(),
    id: definedNonNullAnySchema,
    name: z.string().nullish(),
    positionId: definedNonNullAnySchema.nullish(),
    scoreId: definedNonNullAnySchema.nullish(),
    status: InterviewStatusSchema.nullish(),
    type: InterviewTypeSchema.nullish()
  })
}

export function UpdateSatoriInputSchema(): z.ZodObject<Properties<UpdateSatoriInput>> {
  return z.object<Properties<UpdateSatoriInput>>({
    defaultScoreTemplate: SatoriScoreTemplateSchema.nullish(),
    description: z.string().nullish(),
    id: definedNonNullAnySchema,
    name: z.string().nullish(),
    type: SatoriTypeSchema.nullish()
  })
}

export function UpdateSatoriMapInputSchema(): z.ZodObject<Properties<UpdateSatoriMapInput>> {
  return z.object<Properties<UpdateSatoriMapInput>>({
    description: z.string().nullish(),
    id: definedNonNullAnySchema,
    items: z.array(definedNonNullAnySchema.nullable()).nullish(),
    name: z.string().nullish()
